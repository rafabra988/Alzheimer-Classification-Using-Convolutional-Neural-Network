...
destination_dir = pathlib.Path('./combined_images_binary') 
...
with tf.device('/GPU:0'):
    ...
    #treinando o modelo
    #training the model
    gpu_model.fit(train_ds, validation_data=val_ds, epochs=50, class_weight=class_weights_dict, callbacks=[early_stopping])
    #avaliando o modelo
